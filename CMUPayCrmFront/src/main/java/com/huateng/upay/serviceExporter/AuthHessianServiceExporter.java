package com.huateng.upay.serviceExporter;
...
import com.huateng.crm.bean.RemoteMsg;
...
public class AuthHessianServiceExporter extends HessianServiceExporter {
	private static Logger logger = LoggerFactory.getLogger(AuthHessianServiceExporter.class);
