 ...
 * 类说明 交易流水临时表
 * 对应的数据库表：UPAY_CSYS_TXN_LOG_TMP
 */
public class UpayCsysTxnLogTmp {
	//流水号
    private Long seqId;
    //内部交易流水号
...
//	}
	...
	public String getIntMqSeq() {
		return intMqSeq;
	}

	public void setIntMqSeq(String intMqSeq) {
		this.intMqSeq = intMqSeq;
	}
