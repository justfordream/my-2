...
public class ExcConstant {
	...
	public final static String [] WZW_BODY_MSG_ERROR =  {"Response Xmlbody Schema Validate ERROR","Response SvcContent CDATA NULL"};

	
	//截取异常信息的长度
	public final static Integer MSG_LENGTH_230=230;
	public final static Integer MSG_LENGTH_100=100;
