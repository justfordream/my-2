 ...
 * 类说明  移动侧主号解约请求报文体
 */
public class CrmMainMobileUnBindReqVo {
	//01签约 02 解约 03变更
...
//	@Length(max=32,message="IDValue格式不正确")
	...
	@Pattern(regexp="0001|0002|0003|0004|0005|0006|0007|0008|0009",message="BankID格式不正确")
	...
	private String bankAcctType;//银行账号类型0借记卡 1信用卡
...
//	@NotNull(message="SubTime不能为空")
	...
	private String payType;//缴费方式0主动缴费 1自动缴费
	
	@CustomAnnotation(path="SvcCont.AuthReq.RechAmount")
	//	@Digits(integer=2,fraction=20) TODO
