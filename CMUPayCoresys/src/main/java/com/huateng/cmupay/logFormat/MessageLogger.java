...
import com.huateng.toolbox.utils.ConverStr;
...
public class MessageLogger {
	...
	public void debug(String logPoint) {
		String tmp = convMessage(ExcConstant.LOG_LEVEL_BUSINESS, logPoint,
				this.getInstance(), this.getModule());
	...
	public void debug(String logPoint, Throwable t) {
		...
		logger.debug(new StringBuilder().append(getRegular(t)).append(tmp)
				.toString(), t);
	}

	public void info(String logPoint) {
		String tmp = convMessage(ExcConstant.LOG_LEVEL_INFO, logPoint,
				this.getInstance(), this.getModule());
	...
	public void info(String logPoint, Throwable t) {
		...
		logger.info(new StringBuilder().append(getRegular(t)).append(tmp)
				.toString(), t);
	}

	public void succ(String logPoint) {
		String tmp = convMessage(ExcConstant.LOG_LEVEL_SUCC, logPoint,
				this.getInstance(), this.getModule());
		logger.info(new StringBuilder().append(getRegular(null)).append(tmp)
				.toString());
	}
	...
	public void warn(String logPoint) {
		String tmp = convMessage(ExcConstant.LOG_LEVEL_WARNING, logPoint,
				this.getInstance(), this.getModule());
	...
	public void warn(String logPoint, Throwable t) {
		...
		logger.warn(new StringBuilder().append(getRegular(t)).append(tmp)
				.toString(), t);
	}

	public void error(String logPoint) {
		String tmp = convMessage(ExcConstant.LOG_LEVEL_SERIOUS, logPoint,
				this.getInstance(), this.getModule());
		logger.error(tmp);
	}
	...
	public void error(String logPoint, Throwable t) {
		...
		logger.error(new StringBuilder().append(getRegular(t)).append(tmp)
				.toString(), t);
	}
	...
	public void alarm(String logPoint) {
		String tmp = convMessage(ExcConstant.LOG_LEVEL_ALARM, logPoint,
				this.getInstance(), this.getModule());
		logger.warn(new StringBuilder().append(getRegular(null)).append(tmp)
				.toString());
	}
	...
	private String convMessage(final String p_loglevel, final String p_logmsg,
			final String p_instance, final String p_module) {
