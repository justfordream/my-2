 ...
 * 
 */
@Service("crmSubConnectBus")
public class CrmSubConnectBus extends
...
//	private @Value("${retry.num}") Integer retryNum;
	...
	public CrmMsgVo execute(CrmMsgVo msgVo, Map<String, Object> params, UpayCsysTxnLog txnLog,
		  ...
		  logger.debug("CrmSubConnectBus execute - start,内部交易流水号{}.", txnLog.getIntTxnSeq()); 
			try {	
			...
			logger.debug("CrmSubConnectBus execute - end,内部交易流水号{}.", txnLog.getIntTxnSeq()); 
	     return msgVo;
	}
