package com.huateng.cmupay.log;
...
public class MessageLogger {
	...
	private static final String LOG_LEVEL_BUSINESS = "BUSINESS";
		...
		private static final String LOG_LEVEL_SUCC = "SUCC";
	
		private static final String LOG_LEVEL_WARNING = "WARNING";
		
		private static final String LOG_LEVEL_SERIOUS = "SERIOUS";
	
		private static final String LOG_LEVEL_ALARM = "ALARM";
	
		private static final String APP_ID = "upay";
		private static final String CORE_SUB_SYS  = "Security";
	    private Logger logger = LoggerFactory.getLogger(this.getClass());;
	    
	    private String  module = "Security";
	    ...
	    private static String getRegular(Object t) {
	     ...
	     public  void debug(String logPoint) {
			String tmp = convMessage( LOG_LEVEL_BUSINESS, logPoint, this.getInstance(), this.getModule());
		...
		public  void info(String logPoint) {
			String tmp = convMessage( LOG_LEVEL_INFO, logPoint, this.getInstance(), this.getModule());
		...
		public  void succ(String logPoint) {
			String tmp = convMessage( LOG_LEVEL_SUCC, logPoint, this.getInstance(), this.getModule());
			logger.info(new StringBuilder().append(getRegular(null)).append(tmp)
					.toString());
		}
		...
		public  void warn(String logPoint) {
			String tmp = convMessage( LOG_LEVEL_WARNING, logPoint, this.getInstance(), this.getModule());
		...
		public  void error(String logPoint) {
			String tmp = convMessage( LOG_LEVEL_SERIOUS, logPoint, this.getInstance(), this.getModule());
			logger.error(tmp);
		}
		...
		public  void alarm(String logPoint) {
			String tmp = convMessage( LOG_LEVEL_ALARM, logPoint, this.getInstance(), this.getModule());
			logger.warn(new StringBuilder().append(getRegular(null)).append(
					tmp).toString());
		}
		@Deprecated
