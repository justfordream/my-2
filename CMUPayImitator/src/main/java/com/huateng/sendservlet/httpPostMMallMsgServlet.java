 ...
 * 输入：http地址端口等
 */
public class httpPostMMallMsgServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private final Logger log = Logger.getLogger(httpPostMMallMsgServlet.class);
	
    public httpPostMMallMsgServlet() {
        super();
    }
...
//        }else{
            try {
                ...
                System.out.println("================仿真发消息================="+httpost.getHeaders("Content-Type").toString());
