...
function sengMsg(address, sendMsg){
	...
	xhr.open("post", "../httpPostMMallMsgServlet", true);
...
function initMesSelect(){
	...
	xhr.open("post", "../InitSelectServlet", true);
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	xhr.send("serverId=12" + "&directoryName=" + directoryName);
}
...
function getSendMesSelect(){
	...
	xhr.open("post", "../InitSelectServlet", true);
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	xhr.send("serverId=13" + "&parentDir=" + parentDir + "&fileName=" + fileName);
}
