 ...
 */
// @Component
public final class EncrypPropertyPlaceholderConfigurer extends
	 ...
	 *            can not be null.
	 */
	public EncrypPropertyPlaceholderConfigurer(
			final StringEncryptor stringEncryptor) {
		super();
		CommonUtils
				.validateNotNull(stringEncryptor, "Encryptor cannot be null");
