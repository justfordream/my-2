...
public class CommonConstant {
	...
	public enum BankOrgCode {
		CMCC("0001", "中国移动系统"), CMB("0002", "招商银行"), CCB("0004", "建设银行"), SPDB(
				...
				"0008", "交通银行"), TMALL("0051", "浙江运营中心(天猫充值)");
	...
	public enum TransCode {
		...
		MasterSignSyn("11100020", "主号签约信息同步"), CrmMasterUnsign("11100030",
				...
				"支付结果通知(后台)"), PayNotice2Gate("15100030","支付网关支付结果通知 核心 至 网关"),tmallCharge("17100010","天猫缴费"),
				tmalltransResultQuery("17100011","天猫交易结果查询"),
...
/*		        CrmMasUnsign2UpaySub("21100030",
	...
	public enum CrmTrans {
		...
		Crm03("T1000154", "副号签约信息同步"), Crm04("T1000155", "银行预签约接口"), Crm05(
				...
				"用户身份验证"), Crm16("T1000151", "手机号码信息查询"),Crm17("T1000167", "充值");
	...
	public enum TmallTrans{
		Tmall03("012003",
				"（天猫）充值交易状态请求（全网方案）"),Tmall04("012004",
						"（天猫）充值交易状态查询（全网方案）");
...
//		PayFee("01", "缴预存"), PayPre("02", "缴话费");old
	 ...
	 */
	public enum BussChl {
		province("01","省厅"),bank("02","银行"),webGate("03","支付网关"),tmall("81","天猫");
		String value;
		String desc;
	...
	public enum RspCode {
		...
		WZW_2998("2998", "失败"), WZW_0105("0105", "OSN发现Message Header 格式错误"), WZW_2011(
				...
				"2009", "业务暂停服务"), WZW_0113("0113", "HSN内部错误"),CRM_3A36("3A36", "该营销活动不存在"),CRM_3A37("3A37", "营销活动已过期"),
				UPAY_U99998("U99998", "超时"),CRM_5A02("5A02",
						"充值失败");
		String value;
		String desc;

		private RspCode(String value, String desc) {
			this.value = value;
			this.desc = desc;
		}
	 ...
	 */
	public enum PayMode {
		batTrade("00","批量交易方式"),onlineTrade("01","联网交易方式"),onlinePreTrade("02","联网待支付交易方式");
